...
public class FileNameConst {
    ...
    public static final String FRUITS_VEGETABLES_RATIO = "fruitsVegetablesRatio";
    ...
    public static final String VOLUNTARY_ACTIVITIES_RATIO = "voluntaryActivitiesRatio";
    ...
    public static final String FINANCIAL_SATISFACTION = "financialSatisfaction";
    ...
    public static final String GETTING_TOGETHER_RATIO = "gettingTogetherRatio";
    public static final String NON_PARTICIPATION_RATIO = "nonParticipationRatio";
