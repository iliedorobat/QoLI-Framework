...
public class EducationParams {
    ...
    public static final MultiValuedMap<String, String>
            DIGITAL_SKILLS_PARAMS = getDigitalSkillsParams(),
            DROPOUT_RATIO_PARAMS = getDropoutParams(),
            EARLY_EDUCATION_RATIO_PARAMS = getEarlyEducationParams(),
            INACTIVE_YOUNG_RATIO_PARAMS = getInactiveYoungParams(),
            NO_KNOWN_FOREIGN_LANG_RATIO_PARAMS = getNoKnownForeignLangParams(),
            PUPILS_RATIO_2012_PARAMS = getPupilsParams2012(),
            PUPILS_RATIO_2013_PARAMS = getPupilsParams2013(),
            STUDENTS_RATIO_PARAMS = getEducationParams(),
            TRAINING_RATIO_PARAMS = getTrainingParams();
}
