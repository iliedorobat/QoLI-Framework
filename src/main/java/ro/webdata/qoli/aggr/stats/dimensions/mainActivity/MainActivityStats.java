...
public class MainActivityStats {
    ...
    public static Map<String, Number> generateAggrStats(List<String> aggrList, List<String> countryCodes, int startYear, int endYear) {
        return StatsUtils.generateStats(aggrList, countryCodes, startYear, endYear, MAIN_ACTIVITY, AGGR_PARAMS, AGGR_REVERSED_STATES, aggrIndicators);
    }
    ...
    public static Map<String, Number> generateBaseStats(List<String> aggrList, List<String> countryCodes, int startYear, int endYear) {
        return StatsUtils.generateStats(aggrList, countryCodes, startYear, endYear, MAIN_ACTIVITY, IND_PARAMS, IND_REVERSED_STATES, baseIndicators);
    }
