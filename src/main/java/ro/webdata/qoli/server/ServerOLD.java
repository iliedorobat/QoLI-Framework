...
public class ServerOLD {
    ...
    private static final Logger LOGGER = Logger.getLogger(ServerOLD.class.getName());
...
//                    .setClientMode(false)    // ServerOLD mode
...
//            return server;
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(ServerOLD.class.getName()).log(Level.SEVERE, null, e);
        }
    }
